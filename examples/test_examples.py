...
text = 'Because of this,  ZZZZZ  reported experiencing suicidal thoughts, mainly occurring when she is washing up knives after eating.'
text = 'There is serious concern that  ZZZZZ  could harm herself and her baby with her present pattern of using Risperidone.'
text = "Mood - feels low and unable to cope, has taken overdoses in past, says can't do that now because of children but feels needs help, poor appetite, poor sleep, anhedonia, difficulty coping."
text = "When confronted with the discrepancy between this and her previous admissions of deliberate self harm, she admitted taking an intentional overdose though she would not disclose her intent at the time or current plans beyond admitting she has had many recent thoughts of wishing she wasn't alive."
text = """It was difficult to access Ms.  ZZZZZ 's thoughts due to her guardedness. She appeared quite flat, and weeped during the interview. She said she wanted to go home and tried to give reassurances that she wouldn't harm herself if we'd discharge her. However, she was not convincing with such reassurances, and they conflicted with her refusal to talk about her recent self harm. No psychotic symtomatology was elicited, and her guardedness did not present as paranoid in nature but rather as an attempt to minimise her presentation to medical staff. She said that she would engage with services if we'd send her home and was obviously very upset at the idea of an admission to a psychiatric ward for a period of assessment and as an opportunity to gvie her some time away from her psychosocial stressors."""
